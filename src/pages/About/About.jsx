...
const imgs =
  "https://campustocrypto.s3.ap-south-1.amazonaws.com/source/c2c-grp.JPG";
const team = [
  {
    img: imgs,
      ...
      <div className="About-contant">
            ...
            <div className="A-section-right2">
              <div className="sub-content1">
                ...
                <div className="sub-content1-right">
                  ...
                  <span>
                    It’s all started with group of students. And strong
                    supporter of Bitcoin Blockchain.
                  </span>
                </div>
              </div>
              <div className="sub-content1">
                ...
                <div className="sub-content-right">
                  ...
                  <span>Joining a community doesn’t need your dollars.</span>
                </div>
              </div>
              <button>
        ...
        <div className="About-section2">
          <div className="about-section2-left">
            <h3>Our Mission</h3>
            <span>
              Our mission is to foster a vibrant and inclusive ecosystem where
              individuals from all backgrounds can come together to exchange
              ideas, share knowledge
            </span>
            <ul>
              <li>
                <img src={Tick} alt="tick icon" />
                Project Collaboration: contribute to open-source.
              </li>
              <li>
                <img src={Tick} alt="tick icon" />
              ...
              <li>
                <img src={Tick} alt="tick icon" />
                Supportive Community: Join a supportive and welcoming community{" "}
              </li>
            </ul>
          </div>
      ...
      <div className="our-team-img">
        <div className="grid">
          <div className="inside-grid">
            ...
            {windowWidth < 720 && <img src={grid} alt="second-image" />}
          </div>
        </div>
