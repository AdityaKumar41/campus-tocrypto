          ...
          <div className="frame-parent8">
            ...
            <div className="frame-parent9">
              ...
              <button className="button1">
                <div className="text1">
                  <div className="try-for-free1"><a href={groupDetails.group1.joinLink} target='_blank' rel='noreferrer'>Register Now</a></div>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="frame-parent8">
            ...
            <div className="frame-parent9">
              ...
              <button className="button1 no-work-btn" style={{ cursor: 'not-allowed' }}>
                <div className="text1">
                  <div className="inactive-btn" ><a href={groupDetails.group2.joinLink}>Register Now</a></div>
                </div>
              </button>
            </div>
          </div>
